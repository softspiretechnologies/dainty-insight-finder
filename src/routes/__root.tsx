...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DaintyHand — Premium handcrafted gifts & celebration studio, Kerala" },
      ...
      { property: "og:title", content: "DaintyHand — Premium handcrafted gifts & celebration studio, Kerala" },
      { property: "og:description", content: "Custom hampers, bouquets, invitations, engagement gifts and celebration services handcrafted by Nafisa in Perinthalmanna, Kerala." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@dainty.handd" },
      { name: "twitter:title", content: "DaintyHand — Premium handcrafted gifts & celebration studio, Kerala" },
      { name: "twitter:description", content: "Custom hampers, bouquets, invitations, engagement gifts and celebration services handcrafted in Kerala." },
