...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Custom hampers, bouquets, invitations and celebration services handcrafted by Nafisa in Perinthalmanna, Kerala." },
      { name: "author", content: "DaintyHand" },
      { property: "og:title", content: "DaintyHand — Handcrafted Gifts & Wedding Studio, Kerala" },
      { property: "og:description", content: "Custom hampers, bouquets, invitations and celebration services handcrafted by Nafisa in Perinthalmanna, Kerala." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@dainty.handd" },
      { name: "twitter:title", content: "DaintyHand — Handcrafted Gifts & Wedding Studio, Kerala" },
      { name: "twitter:description", content: "Custom hampers, bouquets, invitations and celebration services handcrafted in Kerala." },
