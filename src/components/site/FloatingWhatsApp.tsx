...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 md:bottom-8 md:right-8 z-50 group flex items-center gap-3 bg-[#25D366] text-white pl-4 pr-5 py-3 rounded-full shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all"
    >
